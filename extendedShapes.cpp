...
namespace aluminum {
	...
	void addRect(MeshData &m, float w, float h, float d, vec3 center) {
		...
		//8 vertices
		vec3 v0 = vec3(-w2+x, -h2+y, +d2+z);
		vec3 v1 = vec3(-w2+x, +h2+y, +d2+z);
		vec3 v2 = vec3(+w2+x, -h2+y, +d2+z);
		vec3 v3 = vec3(+w2+x, +h2+y, +d2+z);
		vec3 v4 = vec3(-w2+x, -h2+y, -d2+z);
		vec3 v5 = vec3(-w2+x, +h2+y, -d2+z);
		vec3 v6 = vec3(+w2+x, -h2+y, -d2+z);
		vec3 v7 = vec3(+w2+x, +h2+y, -d2+z);
